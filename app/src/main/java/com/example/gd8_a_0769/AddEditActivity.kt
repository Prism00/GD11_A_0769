package com.example.gd8_a_0769
...
import com.example.gd8_a_0769.api.MahasiswaApi
import com.example.gd8_a_0769.models.Mahasiswa
...
class AddEditActivity : AppCompatActivity() {
    ...
    private fun getMahasiswaById(id: Long) {
        ...
        val stringRequest: StringRequest = object :
            StringRequest(
                Method.GET,
                MahasiswaApi.GET_BY_ID_URL + id, Response.Listener { response ->
                    val gson = Gson()
